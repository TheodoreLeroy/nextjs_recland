      ...
      <div className="container">
        <div className="hero-wrapper">
          ...
          <div className="hero-left-content fade-in-left">
            ...
            <h1 className="hero-title">
              Tuyển dụng bằng{" "}
              <span className="text-gradient">mạng lưới Recruiter</span> lớn
              nhất Việt Nam
            </h1>
          ...
          <div className="hero-right-mockup fade-in-top">
            <div className="mockup-container">
              ...
              <div className="mockup-card card-pipeline z-9">
                <div
                  className={`pipeline-header mb-4 flex items-center
                    justify-between`}
                >
                  <h4 className="card-section-title m-0 leading-1">
                    HIRING PIPELINE
                  </h4>
                  <span
                    id="realtime-pipeline-date"
                    className={`font-['Inter] text-[0.725rem] font-bold
                      text-[#7984a5] opacity-85`}
                  ></span>
                  {/* <script>
                                        (function () {
                                            var now = new Date();
                                            ...
                                            document.getElementById('realtime-pipeline-date').textContent = dateString;
                                        })();
                                    </script> */}
                </div>
              ...
              <div className="mockup-card card-earnings z-8">
                ...
                <div className="earnings-trend">
                  <i
                    className={`trend-icon inline-flex h-2.5 w-2.5 items-center
                      justify-center`}
                  >
                    <svg
                      width="10"
        ...
        <div className="new-post">
          <svg className="icon-svg me-2">
            <use xlinkHref="assets/images/icons/icon.svg#web"></use>
          </svg>
          <span> MỚI NHẤT</span>
          <a
            className="name"
            target="_blank"
            href="blog/top-cac-web-tuyen-dung-uy-tin-nhat-tai-viet-nam-nam-2026-YNbrMvLF.html"
          >
            Trong thời đại số, việc tìm việc hay tuyển dụng không còn chỉ phụ
            thuộc vào mạng lưới cá nhân...
          </a>
        </div>
      </div>
