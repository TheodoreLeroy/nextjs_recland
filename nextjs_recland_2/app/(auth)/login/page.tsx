  ...
  return (
    <div className="relative flex min-h-screen w-full items-stretch overflow-hidden pt-20 md:pt-24 lg:pt-26">
      ...
      <div className="z-10 flex w-full items-center justify-center bg-white px-6 py-12 md:w-1/2 lg:px-16 xl:px-24">
        <div className="w-full max-w-110">
          ...
          <div className="mb-6 grid grid-cols-2 gap-4">
            <button className="flex items-center cursor-pointer justify-center gap-2 rounded-xl border border-gray-300 py-2.5 font-medium text-gray-700 transition hover:bg-gray-50">
              <img
          ...
          >
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <a href="#" className="font-medium text-sky-500 hover:underline">
                Tạo tài khoản ngay
              </a>
            </p>
          </Form>
      ...
      <div className="relative hidden items-center justify-center overflow-hidden bg-slate-900 md:flex md:w-1/2 md:rounded-bl-[20rem]">
        ...
        {/* Text Nội dung trên Banner
        <div className="relative z-10 flex max-w-lg flex-col items-center justify-center p-8 font-serif text-white">
          <div className="relative mb-2">
            <div className="relative h-12 w-24 rounded-t-full border-t-4 border-r-4 border-l-4 border-white">
              <div className="absolute -top-3 left-1/2 h-4 w-4 -translate-x-1/2 rounded-full border-4 border-white bg-transparent"></div>
            </div>
            <div className="mx-auto mt-1 h-1.5 w-32 bg-white"></div>
          </div>

          <h2 className="mb-2 text-center text-5xl font-medium tracking-tight uppercase">
            RECLAND.CO
          </h2>

          <div className="my-3 flex w-full items-center">
            <div className="h-px flex-grow bg-white/60"></div>
            <span className="px-4 font-sans text-lg tracking-[0.15em] whitespace-nowrap text-white/90 uppercase italic">
              Feel the vibe, don't be shy
            </span>
            <div className="h-px flex-grow bg-white/60"></div>
          </div>

          <p className="text-center font-sans text-xs leading-relaxed tracking-wider text-white/80 uppercase italic">
            Every dish is a journey, from the old town of Hoi An
            <br />
